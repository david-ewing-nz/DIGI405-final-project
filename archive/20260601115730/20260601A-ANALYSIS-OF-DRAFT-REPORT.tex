...
\hline
The neutral label may have introduced systematic ambiguity in this dataset:
...
\hline
But the hard cases may involve genuine ambiguity, not model failure:
\begin{itemize}[leftmargin=*,topsep=2pt,itemsep=1pt,parsep=0pt]
...
\hline
The model and the annotators share a rough understanding that certain vocabulary is negative, but their labels diverge:
\begin{itemize}[leftmargin=*,topsep=2pt,itemsep=1pt,parsep=0pt]
