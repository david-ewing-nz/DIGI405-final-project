...
\begin{itemize}[leftmargin=*,topsep=2pt,itemsep=1pt,parsep=0pt]
  \item The model and annotators share a rough understanding that certain vocabulary is negative.
  \item The model predicts negative, and the tweet probably is negative in some sense.
  \item But annotators labelled it neutral --- possibly because the expression was not strong enough to trigger the positive or negative label.
\end{itemize} & \\
\hline
