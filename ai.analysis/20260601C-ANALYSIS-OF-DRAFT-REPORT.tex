...
\hline
{\bfseries\itshape On close calls, the majority vote will still produce a label, but not always a reliable one:
\begin{itemize}[leftmargin=*,topsep=2pt,itemsep=1pt,parsep=0pt]
  ...
  \item the resulting label may not reflect genuine consensus.\vspace{2em}
...
\hline
{\bfseries\itshape The same words can carry different sentiment depending on:
\begin{itemize}[leftmargin=*,topsep=2pt,itemsep=1pt,parsep=0pt]
  \item the event being discussed;
  \item who is being addressed;
  \item whether the author is being ironic.\vspace{2em}
\end{itemize}} & \textbf{\textit{DEE: original reconstructed}} \\[2em]
\hline
...
\hline
{\bfseries\itshape The shallow depth restricts the tree to at most seven leaf nodes:
\begin{itemize}[leftmargin=*,topsep=2pt,itemsep=1pt,parsep=0pt]
  \item it is forced to identify only the most discriminating features;
  \item the resulting model is small enough to visualise;
  \item and small enough to interpret directly.\vspace{2em}
\end{itemize}} & \textbf{\textit{DEE: original reconstructed}} \\[2em]
\hline
...
\hline
{\bfseries\itshape VADER was designed specifically for social media sentiment:
\begin{itemize}[leftmargin=*,topsep=2pt,itemsep=1pt,parsep=0pt]
  ...
  \item it includes emoticons and slang.\vspace{2em}
\end{itemize}} & \textbf{\textit{DEE: original reconstructed}} \\[2em]
\hline
...
\hline
{\bfseries\itshape The results are organised into four runs:
\begin{itemize}[leftmargin=*,topsep=2pt,itemsep=1pt,parsep=0pt]
  ...
  \item RUN 4: binary $\times$ decision tree.\vspace{2em}
\end{itemize}} & \textbf{\textit{DEE: original reconstructed}} \\[2em]
\hline
...
\hline
{\bfseries\itshape When I looked at tweets predicted as negative but labelled neutral, a recurring pattern emerged:
\begin{itemize}[leftmargin=*,topsep=2pt,itemsep=1pt,parsep=0pt]
  \item tweets expressing mild dissatisfaction, slight frustration, or low-key complaints;
  \item the kind of expression that sits at the boundary between neutral and negative in everyday language.\vspace{2em}
\end{itemize}} & \textbf{\textit{DEE: original reconstructed}} \\[2em]
\hline
...
\hline
{\bfseries\itshape A combined model may outperform any single configuration:
\begin{itemize}[leftmargin=*,topsep=2pt,itemsep=1pt,parsep=0pt]
  \item for example, unigrams plus VADER lexicon plus text statistics;
  \item the interaction effects between feature types are not captured here.\vspace{2em}
\end{itemize}} & \textbf{\textit{DEE: original reconstructed}} \\[2em]
\hline
